...
const addPlanFeature = (plan: SiteService['plans'][number]) => {
  plan.features.push(`Feature ${plan.features.length + 1}`);
};

const removePlanFeature = (plan: SiteService['plans'][number], index: number) => {
              ...
              >
                <div class="flex items-start gap-4">
                  ...
                  <div class="flex-1 space-y-4">
                    ...
                    <div class="space-y-3">
                      <div class="flex items-center justify-between">
                        <label class="text-xs text-slate-500 uppercase">Features</label>
                        <button
                          @click="addPlanFeature(plan)"
                          type="button"
                          class="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-white/5 text-sky-400 text-xs hover:bg-white/10 transition-colors"
                        >
                      ...
                      <div class="space-y-2">
                        ...
                        >
                          <input
                            ...
                            type="text"
                            class="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-sky-500"
                            placeholder="Masukkan fitur plan"
                          />
                          <button
                            @click="removePlanFeature(plan, featureIndex)"
                            type="button"
